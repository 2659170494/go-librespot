...
sudo bash sdkmanager "platforms;android-29" "platforms;android-33" "build-tools;34.0.0" "extras;google;m2repository" "extras;android;m2repository" "ndk;26.3.11579264";
#↑also you can install "build-tools;33.0.2" "build-tools;29.0.2" "build-tools;30.0.3" "ndk-bundle" "ndk;21.3.6528147" 
#↑install android sdk
#↓install JDK 8 
